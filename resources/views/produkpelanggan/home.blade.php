...
<h2>Produk</h2>
	...
	<?php $no++ ;?>
		<tr>
			...
			<td><center><a href="/produk/{{$prd->id}}"><input type="submit" name="beli" value="Beli" class="btn btn-primary"></a></center></td>
			<td><a class="btn btn-info pull-right" href="{{ url('produk/cart/'.$prd->id) }}"><i class="fa fa-shopping-cart"></i> add to cart</a></td>
